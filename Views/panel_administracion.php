    ...
    <header class="header-adm">
        <nav class="nav-adm">
            ...
            <ul class="menu-adm menu">
                <li class="menu-adm__item"><a class="menu-adm__enlace" href="panel_administracion.php">Inicio</a></li>
                <li class="menu-adm__item"><a class="menu-adm__enlace" href="administrar_productos.php">Administrar productos</a></li>
